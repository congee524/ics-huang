...
make_group(gp2,
    EX(rol), EMPTY, EMPTY, EMPTY,//the first is rol
...
opcode_entry opcode_table [512] = {
  ...
  /* 0xe4 */	IDEXW(I2a, in, 1), IDEXW(I2a, in, 1), EMPTY, EMPTY,
  ...
  /* 0xf8 */	EMPTY, EMPTY, IDEX(E, gp3), EMPTY,
  ...
  /* 0x90 */	IDEXW(setcc_E, setcc, 1), IDEXW(setcc_E, setcc, 1), IDEXW(setcc_E, setcc, 1), IDEXW(E, setcc, 1),
  /* 0x94 */	IDEXW(setcc_E, setcc, 1), IDEXW(setcc_E, setcc, 1), IDEXW(setcc_E, setcc, 1), IDEXW(E, setcc, 1 ),
  /* 0x98 */	IDEXW(setcc_E, setcc, 1), IDEXW(setcc_E, setcc, 1), IDEXW(setcc_E, setcc, 1), IDEXW(E, setcc, 1),
